...
from .spot import search_releases
...
class ResultTreeView(HintedTreeView, MultiDragTreeView):
    ...
    def __track_datafunc(self, col, cell, model, itr, data):
        ...
        if idx >= len(self._tracks):
            ...
            cell.set_property('text', str(self._tracks[idx].tracknumber))
    ...
    #         cell.set_property('text', '')
    #     else:
    #         cell.set_property('text', str(self._tracks[idx].discnumber))
...
class SearchWindow(Dialog):
    ...
    def __init__(self, parent, album):
        ...
        super(SearchWindow, self).__init__(_("Spotify lookup"))
